        ...
        <>
            <div className="flex justify-center flex-col flex-wrap p-8" id='contact'>
                ...
                <motion.div initial='hidden' whileInView={'visible'} className='' variants={ContainerVariant} viewport={{ once: true }}>
                    ...
                    <motion.h1 className='text-2xl md:text-4xl leading-none mb-4' variants={textVariant} >{CONTACT_CONTENT.headline}</motion.h1>
                    <motion.p className='text-xl md:text-2xl' variants={textVariant} >{CONTACT_CONTENT.description}</motion.p>
